...
export const metadata: Metadata = {
  title: "Cuenta para empresas — Tapago Pay",
  description: "Solicitá la apertura de cuenta para tu empresa en Tapago Pay. Pagos internacionales para personas jurídicas.",
}
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-start">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="rounded-2xl border border-teal-200 bg-teal-50 p-6">
                <p className="text-sm font-medium text-teal-800">
                  ¿Necesitás más información antes de completar el formulario?
                </p>
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-2xl border border-border bg-card p-6 shadow-sm md:p-8">
                <h2 className="mb-6 text-lg font-bold text-foreground">Solicitud de apertura de cuenta — Empresa</h2>
